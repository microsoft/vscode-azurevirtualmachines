...
import { createVirtualMachine, delay, getRandomHexString } from "../../extension.bundle";
import { getRotatingLocation } from "./getRotatingValue";
import { resourceGroupsToDelete } from './global.resource.test';

suite('Create a virtual machine', () => {
    ...
    test('Create Linux virtual machine', async () => {
        ...
        const testInputs: (string | RegExp)[] = [resourceName, '', getRotatingLocation()];
