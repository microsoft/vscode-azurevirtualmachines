...
console.log('Hello from SignFiles.js');
console.log('AGENT_TEMPDIRECTORY: ', process.env.AGENT_TEMPDIRECTORY);
console.log('MBSIGN_APPFOLDER: ', process.env.MBSIGN_APPFOLDER);
console.log('BUILD_SOURCESDIRECTORY: ', process.env.BUILD_SOURCESDIRECTORY);

const tempSigningDir = path.join(process.env.AGENT_TEMPDIRECTORY || tmpdir(), 'signing')
 ...
 */
export function signFiles(FilesArray) {
